<section>
        ...
        <div id="carouselExampleFade" class="carousel slide carousel-fade" data-bs-slide="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    ...
                    <div class="deskripsi">
                        <div class="garis"></div>
                        <h3>Aroma yang kuat dan memikat, menghadirkan kekuatan dan daya tarik yang tak tertandingi</h3>
                    </div>
                </div>
    ...
    <div class="container-relative">
        <h2 class="redsco2 absoluteposition"><span class="red-text">Red</span><span class="white-text">Sco.</span>
        </h2>
        <img src="{{ asset('img/img9.png') }}" class="gambar absoluteposition gambar" alt="" />
        <img src="{{ asset('img/img12.png') }}" class="gambar absoluteposition gambar" alt="" />
        <img src="{{ asset('img/img10.png') }}" class="gambar absoluteposition gambar" alt="" />

        <div class="kuisioner absoluteposition">
            <h1 class="me-auto"><span class="white-text">KUISIO</span><span class="red-text">NER</span></h1>

        </div>
        <h3 class="deskrip3 absoluteposition">Lorem ipsum dolor sit <br> amet consectetur adipisicing elit. <br> Iusto
            inventore est.</h3>
    </div>
</section>
